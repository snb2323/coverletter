...
export default function Preinterview() {
    ...
    const answers = [
        "요식업에서의 경험을 통해 디지털 플랫폼의 중요성을 깨닫고, 레스토랑에서의 효율적인 서비스와 빠른 응대 경험에서 웹과 개발에 대한 흥미가 동시에 자라게 되었습니다. 이로 인해 개발자로의 전향을 결정하게 되었으며, 사용자 중심의 디지털 경험을 창조하고 싶은 열망이 높아졌습니다. 지금은 디지털 환경에서 놀라운 기술과 창의적인 디자인을 결합하여 사용자들에게 새로운 가치를 제공하기 위해 열심히 노력하고 있습니다.",
    ...
    return (
        <>
            <div className="prewrap">
                ...
                <div className="interivew d-flex align-items-center justify-content-center">
                    <fieldset>
                        <legend>
